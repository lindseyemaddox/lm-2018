...
;(function ($) {
  ...
  $.flexslider.defaults = {
    ...
    selector: ".slides > a.box",       //{NEW} Selector: Must match a simple pattern. '{container} > {slide}' -- Ignore pattern at your own peril
    ...
    slideshowSpeed: 800,           //Integer: Set the speed of the slideshow cycling, in milliseconds
